...
def create(frame):
    ...
    setup_btn_img = Image.open("Icons/setup_btn_img.png").resize((130,250), Image.ANTIALIAS)
    setup_btn_icon = ImageTk.PhotoImage(setup_btn_img)
    global analyze_btn_icon
    analyze_btn_img = Image.open("Icons/analyze_btn_img.png").resize((130,250), Image.ANTIALIAS)
    analyze_btn_icon = ImageTk.PhotoImage(analyze_btn_img)
    global control_btn_icon
    control_btn_img = Image.open("Icons/control_btn_img.png").resize((130,250), Image.ANTIALIAS)
    control_btn_icon = ImageTk.PhotoImage(control_btn_img)
    global status_btn_icon
    status_btn_img = Image.open("Icons/status_btn_img.png").resize((130,250), Image.ANTIALIAS)
